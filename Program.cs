...
Console.WriteLine($"{r1.ComoTexto()} es fracción equivale a {r1.Fraccion():F6}");
Console.WriteLine($"{r2.ComoTexto()} es fracción equivale a {r2.Fraccion():F6}");
...
Console.WriteLine($"{r3.ComoTexto()} - {r1.ComoTexto()} = {(r3.Resta(r1)).ComoTexto()}");
